...
class FullScreenPhotoViewController: UIViewController, CAAnimationDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL.init(string: (friendsImage[index].photo604!))
    ...
    @objc func onPan(_ recognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            if canSlide(direction) {
                ...
                let urlNext = URL.init(string: (friendsImage[nextIndex].photo604!))
                ...
                animator.addCompletion { (position) in
                    ...
                    let url = URL.init(string: (self.friendsImage[self.index].photo604!))
                    let data = try? Data(contentsOf: url!)
