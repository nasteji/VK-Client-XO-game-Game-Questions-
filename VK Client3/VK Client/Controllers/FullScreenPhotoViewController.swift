...
class FullScreenPhotoViewController: UIViewController, CAAnimationDelegate {
    ...
    override func viewDidLoad() {
        ...
        let data = try? Data(contentsOf: friendsImage[index].sizes.last!.url)
    ...
    @objc func onPan(_ recognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            if canSlide(direction) {
                ...
                let dataNext = try? Data(contentsOf: friendsImage[nextIndex].sizes.last!.url)
                ...
                animator.addCompletion { (position) in
                    ...
                    let data = try? Data(contentsOf: self.friendsImage[self.index].sizes.last!.url)
