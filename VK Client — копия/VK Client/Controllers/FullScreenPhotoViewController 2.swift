...
class FullScreenPhotoViewController: UIViewController, CAAnimationDelegate {
    ...
    override func viewDidLoad() {
        ...
        imageView.image = UIImage(named: friendsImage[index])
    ...
    @objc func onPan(_ recognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            if canSlide(direction) {
                ...
                nextImageView.image = UIImage(named: friendsImage[nextIndex])
                ...
                animator.addCompletion { (position) in
                    ...
                    self.imageView.image = UIImage(named: self.friendsImage[self.index])
